...
// We depend on the UserDTO not the User class from domain
  ...
  String get description =>
      throw _privateConstructorUsedError; // This is the only field with a different json key or type to our field name or type
...
abstract class _GithubRepoDTO extends GithubRepoDTO {
  ...
  @override
  String get name;
  @override // Ensuring we never receive null
  @JsonKey(fromJson: _descriptionFromJson)
  String get description;
  @override // This is the only field with a different json key or type to our field name or type
  @JsonKey(name: 'stargazers_count')
